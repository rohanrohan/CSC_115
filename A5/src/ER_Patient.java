...
public class ER_Patient implements Comparable {
	...
	public int compareTo(Object other) {
		if (!(other instanceof ER_Patient)) {
			throw new ClassCastException("Cannot compare this object with an ER_Patient");
		}
		ER_Patient otherPatient = (ER_Patient)other;
		int priorityDiff = this.priorityNum - otherPatient.priorityNum;
		if (priorityDiff != 0) {
			return priorityDiff;
		} else {
			return this.admitTime.compareTo(otherPatient.admitTime);
		}
	}
